...
class KalmanFilter(Module):
    ...
    @staticmethod
    def Gaussian_log_density(mean, covariance, sample) -> Tensor:
        """
    ...
    @staticmethod
    def Bayes_update(prior_mean, prior_covariance, observation, observation_weight, observation_bias, observation_kernel_covariance):
    ...
    @staticmethod
    def propagate(prev_mean, prev_covariance, kernel_weight, kernel_bias, kernel_covariance):
    ...
    def forward(self, time_extent: int, observation: Tensor):
        ...
        for t in range(time_extent):
            predictive_mean, predictive_covariance = self.propagate(posterior_means[t], posterior_covariances[t], dynamic_weight, dynamic_bias, dynamic_covariance)
            observation_mean, observation_covariance = self.propagate(predictive_mean, predictive_covariance, observation_weight, observation_bias, observation_kernel_covariance)
